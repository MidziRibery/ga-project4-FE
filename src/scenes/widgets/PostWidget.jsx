import {
  ...
  const PostWidget = ({
    ...
    const patchLike = async () => {
      ...
      const response = await fetch(`https://fair-red-capybara.cyclic.app/posts/${postId}/like`, {
        method: "PATCH",
        headers: {
      ...
      <WidgetWrapper m="2rem 0">
        ...
        {picturePath && (
          <img
            ...
            src={`https://fair-red-capybara.cyclic.app/assets/${picturePath}`}//this is the issue, but why? it should be under data/index.js
          />
        )}
